        ...
        <section className="bg-[var(--surface)]" id="how-it-works">
            <div className="max-w-[1400px] mx-auto px-4 md:px-12 py-28 md:py-32">
                <div className="grid lg:grid-cols-2 gap-12 items-end">
                    ...
                    <p ref={textRef} className="reveal-on-scroll font-sans text-[20px] text-[var(--grey)] leading-[1.7] self-end">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-[1px] bg-[var(--border)] mt-16">
                    {HOW_IT_WORKS_STEPS.map((step, i) => (
                        <div key={i} ref={cardRefs[i]} className={`reveal-on-scroll bg-[var(--surface)] p-10 transition-colors hover:bg-[var(--surface2)] ${i === 3 ? 'border-2 border-[rgba(232,0,29,0.5)] animate-pulse' : ''}`}>
