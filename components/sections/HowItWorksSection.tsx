...
export function HowItWorksSection() {
    ...
    return (
        <section ref={sectionRef} className="bg-[var(--surface)]" id="how-it-works">
            <div className="max-w-[1400px] mx-auto px-4 md:px-12 py-28 md:py-32">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-[1px] bg-[var(--border)] mt-16">
                    {HOW_IT_WORKS_STEPS.map((step, i) => (
                        <div key={i} className={`bg-[var(--surface)] p-10 transition-colors hover:bg-[var(--surface2)] reveal-fade-up ${i === 3 ? 'border-2 border-[rgba(232,0,29,0.5)] animate-pulse' : ''}`} style={{ transitionDelay: `${i * 80}ms` }}>
                            ...
                            <div className="font-sans text-[11px] font-bold uppercase tracking-[0.08em] text-[var(--red)] reveal-scale-in" style={{ transitionDelay: `${(i * 80) + 400}ms` }}>
                                {step.time}
                            </div>
                        </div>
                    ))}
