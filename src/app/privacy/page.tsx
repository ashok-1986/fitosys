        ...
        <div className="min-h-screen bg-background">
            ...
            <div className="max-w-3xl mx-auto px-4 py-12">
                ...
                <div className="prose prose-sm text-muted-foreground space-y-4">
                    ...
                    <p>Your data is used to operate the Fitosys platform: sending automated WhatsApp messages, generating AI coaching summaries via Google Gemini, and processing payments through Razorpay. We never use your data for advertising.</p>
                    ...
                    <p>We use Supabase (database), Razorpay (payments), WhatsApp Business API (messaging), and Google Gemini (AI summaries). Each has its own privacy policy. We do not store raw card numbers — Razorpay handles all payment data.</p>
