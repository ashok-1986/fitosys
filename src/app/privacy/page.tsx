        ...
        <div className="min-h-screen bg-background">
            ...
            <div className="max-w-3xl mx-auto px-4 py-12">
                ...
                <div className="prose prose-sm text-muted-foreground space-y-4">
                    ...
                    <p>Your data is used to operate the Fitosys system: sending automated WhatsApp messages, generating AI coaching summaries, and processing payments through Razorpay. We never use your data for advertising.</p>
