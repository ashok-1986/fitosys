        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-left">
            ...
            <div data-hero-eyebrow className="flex items-center gap-3 mb-7">
              ...
              <span className="text-[11px] font-medium tracking-[0.2em] uppercase text-[#F20000]">
            ...
            <div data-hero-cta className="flex flex-wrap gap-4 mb-14">
              <Button asChild size="lg" className="bg-[#F20000] hover:bg-[#C20000] text-white px-8 h-14 text-[13px] font-medium uppercase tracking-wider border-2 border-[#F20000]">
                <Link href="#contact">Start Free Trial</Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="bg-transparent hover:bg-white/5 text-white px-8 h-14 text-[13px] font-medium uppercase tracking-wider border-2 border-white/15">
            ...
            <div data-hero-stats className="flex flex-wrap gap-12 pt-10 border-t border-[#222222]">
              <div>
                <div className="font-display text-4xl font-medium text-white">2–3<span className="text-[#F20000]">hrs</span></div>
                <div className="text-xs text-[#A0A0A0] mt-1 font-light">saved per week<br />per coach</div>
              </div>
              <div>
                <div className="font-display text-4xl font-medium text-white">₹72<span className="text-[#F20000]">K+</span></div>
                <div className="text-xs text-[#A0A0A0] mt-1 font-light">avg annual revenue<br />recovered from renewals</div>
              </div>
              <div>
                <div className="font-display text-4xl font-medium text-white">30<span className="text-[#F20000]">min</span></div>
          ...
          <div className="relative flex justify-center items-center">
            ...
            <div ref={floatCard1Ref} className="absolute top-[8%] right-[-5%] lg:right-[-8%] bg-[#141414] border border-[#222222] rounded-xl px-5 py-4 z-20 min-w-[200px]">
              <div className="text-[10px] font-medium uppercase tracking-wider text-[#A0A0A0] mb-2">This Week&apos;s Response Rate</div>
              <div className="font-display text-3xl font-medium text-white">73<span className="text-[#F20000]">%</span></div>
            ...
            <div ref={phoneRef} className="relative z-10 flex flex-col items-center gap-0">
              ...
              <div className="flex gap-0.5 bg-[#111111] border border-[#222222] rounded-[40px] p-1 mb-4 z-20 relative">
                <button 
                  ...
                  className={`px-5 py-2 rounded-[36px] font-sans text-[11px] font-medium tracking-[0.08em] uppercase flex items-center gap-1.5 transition-all duration-300 ${activeTab === 'wa' ? 'bg-[#25D366] text-white' : 'bg-transparent text-[#A0A0A0]'}`}
                >
                ...
                <button 
                  ...
                  className={`px-5 py-2 rounded-[36px] font-sans text-[11px] font-medium tracking-[0.08em] uppercase flex items-center gap-1.5 transition-all duration-300 ${activeTab === 'dashboard' ? 'bg-[#F20000] text-white' : 'bg-transparent text-[#A0A0A0]'}`}
                >
                  ...
                  <div className="rounded-[28px] overflow-hidden min-h-[490px] relative bg-[#0A0A0A]">
                    ...
                    <div className={`absolute inset-0 z-20 transition-all duration-[400ms] ease-in-out ${activeTab === 'wa' ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-3 pointer-events-none'}`}>
                      <div className="bg-[#075E54] h-full flex flex-col">
                        ...
                        <div className="bg-[#075E54] px-[14px] pt-[14px] pb-[12px] flex items-center gap-2.5">
                          <div className="w-9 h-9 rounded-full bg-[#F20000] flex items-center justify-center font-sans font-medium text-xs text-white shrink-0">F</div>
                          <div>
                            <div className="font-sans text-[13px] font-medium text-white leading-tight">Fitosys Bot</div>
                            <div className="font-sans text-[10px] text-white/60">for Coach Priya · automated</div>
                          </div>
                          <div className="ml-auto bg-[#F20000]/90 text-white text-[9px] font-medium px-2 py-0.5 rounded-full tracking-[0.08em] shrink-0">AUTO</div>
                        </div>
                    ...
                    <div className={`absolute inset-0 z-10 transition-all duration-[400ms] ease-in-out bg-[#0A0A0A] ${activeTab === 'dashboard' ? 'opacity-100 translate-x-0 z-20' : 'opacity-0 translate-x-3 pointer-events-none'}`}>
                      ...
                      <div className="p-[10px_12px] flex flex-col gap-2.5 overflow-hidden">
                        ...
                        {/* Bar chart */}
                        <div>
                          <div className="text-[9px] font-medium tracking-[0.1em] uppercase text-[#A0A0A0] mb-1.5">Check-ins This Week</div>
                        ...
                        {/* Timeline */}
                        <div>
                          <div className="text-[9px] font-medium tracking-[0.1em] uppercase text-[#A0A0A0] mb-1.5 mt-1">Automation Timeline · Today</div>
                        ...
                        {/* Client list */}
                        <div>
                          <div className="text-[9px] font-medium tracking-[0.1em] uppercase text-[#A0A0A0] mb-1 mt-1">Priority Clients</div>
                          <div className="flex flex-col gap-1">
                            <div className="flex items-center gap-2 p-[5px_8px] bg-[#111111] rounded-[5px]">
                              <div className="w-5 h-5 rounded-full shrink-0 flex items-center justify-center font-sans text-[9px] font-medium text-white bg-[#F20000]">A</div>
                              <div className="text-[10px] text-white font-medium flex-1">Anjali Mehta</div>
                              <div className="text-[8px] font-medium tracking-[0.06em] uppercase px-[6px] py-0.5 rounded-[10px] bg-[#F20000]/15 text-[#F20000]">At Risk</div>
                            </div>
                            <div className="flex items-center gap-2 p-[5px_8px] bg-[#111111] rounded-[5px]">
                              <div className="w-5 h-5 rounded-full shrink-0 flex items-center justify-center font-sans text-[9px] font-medium text-white bg-[#22C55E]">R</div>
                              <div className="text-[10px] text-white font-medium flex-1">Rahul Sharma</div>
                              <div className="text-[8px] font-medium tracking-[0.06em] uppercase px-[6px] py-0.5 rounded-[10px] bg-[#22C55E]/10 text-[#22C55E]">Strong</div>
                            </div>
                            <div className="flex items-center gap-2 p-[5px_8px] bg-[#111111] rounded-[5px]">
                              <div className="w-5 h-5 rounded-full shrink-0 flex items-center justify-center font-sans text-[9px] font-medium text-white bg-[#F59E0B]">V</div>
                              <div className="text-[10px] text-white font-medium flex-1">Vikram Joshi</div>
                              <div className="text-[8px] font-medium tracking-[0.06em] uppercase px-[6px] py-0.5 rounded-[10px] bg-[#F59E0B]/10 text-[#F59E0B]">Renewal Due</div>
                            </div>
                          </div>
                        </div>
            ...
            <div ref={floatCard2Ref} className="absolute bottom-[15%] left-[-5%] lg:left-[-8%] bg-[#141414] border border-[#222222] rounded-xl px-5 py-4 z-20 min-w-[180px]">
              <div className="text-[10px] font-medium uppercase tracking-wider text-[#A0A0A0] mb-2">Renewal Alert</div>
              <div className="font-display text-xl font-medium text-[#F59E0B]">3 clients</div>
              <div className="text-[11px] text-[#A0A0A0] mt-1">programs expiring in 7 days</div>
              <div className="mt-2 text-[10px] text-[#F20000] font-medium uppercase tracking-wider">Reminders sent automatically ✓</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-[2rem] bg-[#111111] border border-[#222222] shadow-2xl shadow-black/40 overflow-hidden">
        ...
        <div className="flex items-center gap-3 px-4 py-2.5 bg-[#0A0A0A] border-b border-[#222222]">
          <div className="h-8 w-8 rounded-full bg-[#F20000]/20 flex items-center justify-center">
            <span className="text-xs font-medium text-[#F20000]">F</span>
          </div>
          <div>
            <p className="text-sm font-medium text-white">Fitosys</p>
          ...
          <div data-insight className="mt-4">
            <div className="bg-[#111111] border border-[#222222] rounded-xl px-4 py-3 shadow-lg">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs font-medium text-white">Anjali — Strong week</span>
              </div>
    ...
    <main className="min-h-screen bg-[#0A0A0A] font-sans selection:bg-[#F20000]/30 selection:text-white">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-[#0A0A0A]/92 backdrop-blur-md border-b border-white/5" : "bg-transparent"}`}>
        <div className="max-w-[1400px] mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
            ...
            <span className="font-display font-medium text-2xl tracking-tight text-white">FITO<span className="text-[#F20000]">SYS</span></span>
          </Link>
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-[#A0A0A0]">
            ...
            <Button asChild className="bg-[#F20000] hover:bg-[#C20000] text-white rounded-full font-medium px-6 border-0">
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-[60] bg-[#0A0A0A]/98 flex flex-col items-center justify-center gap-8">
          ...
          <Link href="#features" className="font-display font-medium text-3xl uppercase text-white" onClick={() => setMobileMenuOpen(false)}>Features</Link>
          <Link href="#how" className="font-display font-medium text-3xl uppercase text-white" onClick={() => setMobileMenuOpen(false)}>How It Works</Link>
          <Link href="#pricing" className="font-display font-medium text-3xl uppercase text-white" onClick={() => setMobileMenuOpen(false)}>Pricing</Link>
          <Link href="#about" className="font-display font-medium text-3xl uppercase text-white" onClick={() => setMobileMenuOpen(false)}>About</Link>
          <Link href="#contact" className="font-display font-medium text-3xl uppercase text-[#F20000]" onClick={() => setMobileMenuOpen(false)}>Contact</Link>
        </div>
      )}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-px bg-[#F20000]" />
                <span className="text-[11px] font-medium tracking-widest uppercase text-[#F20000]">The Problem</span>
              </div>
              ...
              <div className="space-y-0">
                <div className="bg-[#111111] border-l-[3px] border-l-[#F20000] hover:bg-[#141414] transition-colors p-8 cursor-default">
                  <div className="text-[11px] font-medium tracking-widest uppercase text-[#555555] mb-2">01 — REVENUE LEAKAGE</div>
                  <h3 className="text-xl font-medium text-white mb-2">Renewals Slipping Through Gaps</h3>
                  ...
                  <div className="inline-flex items-center gap-2 bg-[#F20000]/10 border border-[#F20000]/20 px-3 py-1 rounded-full text-[#F20000] text-xs font-medium">₹72K–₹1.08L lost annually per coach</div>
                </div>
                <div className="bg-[#111111] border-l-[3px] border-l-transparent hover:border-l-[#F20000] hover:bg-[#141414] transition-colors p-8 cursor-default">
                  <div className="text-[11px] font-medium tracking-widest uppercase text-[#555555] mb-2">02 — ENGAGEMENT BLIND SPOT</div>
                  <h3 className="text-xl font-medium text-white mb-2">No Early Warning for Disengagement</h3>
                  ...
                  <div className="inline-flex items-center gap-2 bg-[#F20000]/10 border border-[#F20000]/20 px-3 py-1 rounded-full text-[#F20000] text-xs font-medium">10–20% annual churn from retention blindness</div>
                </div>
                <div className="bg-[#111111] border-l-[3px] border-l-transparent hover:border-l-[#F20000] hover:bg-[#141414] transition-colors p-8 cursor-default">
                  <div className="text-[11px] font-medium tracking-widest uppercase text-[#555555] mb-2">03 — ADMIN BURNOUT</div>
                  <h3 className="text-xl font-medium text-white mb-2">2–4 Hours Per Week on Non-Coaching Work</h3>
                  ...
                  <div className="inline-flex items-center gap-2 bg-[#F20000]/10 border border-[#F20000]/20 px-3 py-1 rounded-full text-[#F20000] text-xs font-medium">8–12 hours/week average admin overhead</div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-[1400px] mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 mb-20">
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-px bg-[#F20000]" />
                <span className="text-[11px] font-medium tracking-widest uppercase text-[#F20000]">Core Features</span>
              </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-0.5">
            {[
              ...
              <div key={i} className="group bg-[#0A0A0A] p-10 hover:bg-[#141414] transition-colors relative overflow-hidden">
                ...
                <div className="font-display text-6xl font-medium text-[#222222] mb-6 group-hover:text-[#F20000]/15 transition-colors">{feature.num}</div>
                ...
                <span className={`inline-block text-[11px] font-medium tracking-wider uppercase px-3 py-1 rounded-full border ${feature.tagColor}`}>{feature.tag}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-[1400px] mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 mb-16">
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-px bg-[#F20000]" />
                <span className="text-[11px] font-medium tracking-widest uppercase text-[#F20000]">How It Works</span>
              </div>
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-medium text-white leading-tight">
                FOUR STEPS TO<br />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-0.5 relative">
            ...
            {[
              ...
              <div key={i} className="relative bg-[#111111] p-10 group hover:bg-[#141414] transition-colors">
                ...
                <div className="font-display text-7xl font-medium text-[#F20000]/8 mb-4">{item.num}</div>
                <div className="w-8 h-8 rounded-full bg-[#F20000] flex items-center justify-center text-white font-medium text-sm mb-5">{item.step}</div>
                ...
                <div className="flex items-center gap-2 text-[#F20000] text-xs font-medium uppercase tracking-wider">
        ...
        <div className="max-w-[1400px] mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-px bg-[#F20000]" />
                <span className="text-[11px] font-medium tracking-widest uppercase text-[#F20000]">WhatsApp Native</span>
              </div>
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-medium text-white leading-tight mb-6">
                YOUR CLIENTS<br />
      ...
      <section id="ai" className="bg-[#0A0A0A] py-32 relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-display text-[200px] md:text-[320px] font-medium text-[#F20000]/3 uppercase whitespace-nowrap pointer-events-none select-none">INTELLIGENCE</div>
        <div className="max-w-[1400px] mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-px bg-[#F20000]" />
                <span className="text-[11px] font-medium tracking-widest uppercase text-[#F20000]">AI Intelligence</span>
              </div>
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-medium text-white leading-tight mb-6">
                YOUR AI<br />
            ...
            <div className="bg-[#111111] border border-[#222222] rounded-sm overflow-hidden">
              <div className="bg-[#141414] px-6 py-4 flex items-center justify-between border-b border-[#222222]">
                <span className="text-xs font-medium text-white">Monday AI Summary — Week 12</span>
                <span className="bg-[#F20000]/15 border border-[#F20000]/30 px-2.5 py-1 rounded-full text-[9px] font-medium uppercase tracking-wider text-[#F20000]">Gemini Powered</span>
              </div>
              <div className="p-6">
                <div className="text-[11px] font-medium uppercase tracking-wider text-[#A0A0A0] mb-4">March 3–9, 2026 · 28 active clients</div>
                <div className="grid grid-cols-3 gap-3 mb-5">
                  <div className="bg-[#0A0A0A] p-3.5 text-center">
                    <div className="font-display text-2xl font-medium text-[#22C55E]">73%</div>
                    <div className="text-[10px] text-[#A0A0A0] mt-1">Response Rate</div>
                  </div>
                  <div className="bg-[#0A0A0A] p-3.5 text-center">
                    <div className="font-display text-2xl font-medium text-[#F59E0B]">7.1</div>
                    <div className="text-[10px] text-[#A0A0A0] mt-1">Avg Energy</div>
                  </div>
                  <div className="bg-[#0A0A0A] p-3.5 text-center">
                    <div className="font-display text-2xl font-medium text-[#F20000]">3</div>
                    <div className="text-[10px] text-[#A0A0A0] mt-1">Need Attention</div>
                  </div>
                </div>
                <div className="bg-[#F20000]/6 border border-[#F20000]/15 p-4 mb-3">
                  <div className="text-[10px] font-medium uppercase tracking-wider text-[#F20000] mb-2">⚡ This Week&apos;s Priority</div>
                ...
                <div className="bg-[#22C55E]/6 border border-[#22C55E]/15 p-4 mb-5">
                  <div className="text-[10px] font-medium uppercase tracking-wider text-[#22C55E] mb-2">🏆 Strong This Week</div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between bg-[#0A0A0A] px-4 py-2.5">
                      ...
                      <span className={`text-[10px] font-medium uppercase tracking-wider px-2.5 py-1 rounded-full ${client.statusClass}`}>{client.status}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div className="max-w-[1400px] mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className="w-10 h-px bg-[#F20000]" />
              <span className="text-[11px] font-medium tracking-widest uppercase text-[#F20000]">Pricing</span>
              <div className="w-10 h-px bg-[#F20000]" />
            </div>
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-medium text-white leading-tight mb-6">
              BUILT FOR<br />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-0.5">
            {[
              ...
              <div key={i} className={`relative p-10 ${plan.featured ? "bg-[#141414] border-t-2 border-t-[#F20000]" : "bg-[#0A0A0A]"}`}>
                {plan.featured && <span className="absolute top-4 right-4 bg-[#F20000] text-white text-[9px] font-medium uppercase tracking-wider px-2.5 py-1 rounded-full">Most Popular</span>}
                <div className="text-[11px] font-medium uppercase tracking-widest text-[#F20000] mb-3">{plan.tier}</div>
                <div className="font-display text-5xl font-medium text-white mb-1">
                  <sub className="text-lg align-middle text-[#A0A0A0]">₹</sub>{plan.price}
                </div>
                <div className="text-sm text-[#A0A0A0] mb-2">per month</div>
                <div className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium mb-7 ${plan.featured ? "bg-[#F20000]/8 text-white" : "bg-[#F20000]/8 text-[#F20000]"}`}>{plan.clients}</div>
        ...
        <div className="max-w-[1400px] mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 mb-16">
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-px bg-[#F20000]" />
                <span className="text-[11px] font-medium tracking-widest uppercase text-[#F20000]">Coach Stories</span>
              </div>
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-medium text-white leading-tight">
                COACHES WHO<br />
          ...
          <div className="grid md:grid-cols-3 gap-0.5">
            {[
              ...
              <div key={i} className="bg-[#111111] p-10 hover:bg-[#141414] transition-colors group">
                <div className="font-display text-6xl font-medium text-[#F20000]/15 mb-5 leading-none">&quot;</div>
                ...
                <div className="bg-[#F20000]/8 border border-[#F20000]/15 px-4 py-2.5 mb-6 flex items-center gap-3">
                  <span className="font-display text-2xl font-medium text-[#F20000]">{testi.roi}</span>
                  <span className="text-xs text-[#A0A0A0]">{testi.roiDesc}</span>
                </div>
                <div className="flex items-center gap-3.5">
                  <div className={`w-11 h-11 rounded-full bg-gradient-to-br ${testi.gradient} flex items-center justify-center font-display font-medium text-white text-sm`}>{testi.initial}</div>
                  <div>
        ...
        <div className="max-w-[1400px] mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-px bg-[#F20000]" />
                <span className="text-[11px] font-medium tracking-widest uppercase text-[#F20000]">About Fitosys</span>
              </div>
              <div className="font-serif text-2xl md:text-3xl text-white leading-relaxed italic mb-10">
                Fitosys exists because <span className="text-[#F20000] font-display font-medium not-italic uppercase">India&apos;s best coaches</span> shouldn&apos;t be drowning in WhatsApp messages. The system should run. <span className="text-[#F20000] font-display font-medium not-italic uppercase">You should coach.</span>
              </div>
              <p className="text-lg text-[#A0A0A0] leading-relaxed mb-12 max-w-lg">
              ...
              <div className="space-y-0 border-t border-b border-[#222222]">
                {[
                  ...
                  <div key={i} className="flex gap-5 py-6 border-b border-[#222222] last:border-b-0">
                    <span className="font-display text-sm font-medium text-[#F20000] w-8 flex-shrink-0">{item.num}</span>
                    <div>
            ...
            <div className="relative">
              <div className="font-display text-[120px] md:text-[160px] font-medium text-transparent leading-none tracking-tighter" style={{ WebkitTextStroke: "1px rgba(255,255,255,0.08)" }}>
              ...
              <div className="space-y-0.5 mt-[-20px]">
                {[
                  ...
                  <div key={i} className="bg-[#0A0A0A] px-7 py-6 flex items-center justify-between">
                    <span className="font-display text-4xl font-medium text-white">{stat.num}</span>
        ...
        <div className="max-w-[1400px] mx-auto px-4 relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-10">
            <div>
              ...
              <p className="text-white/70 text-sm mt-3 font-light">14-day free trial. No credit card. Setup in 30 minutes.</p>
            </div>
            <Button asChild size="lg" className="bg-white text-[#F20000] hover:bg-white/90 text-white px-10 h-14 text-sm font-medium uppercase tracking-wider border-2 border-white">
              <Link href="#contact">Start Free Trial</Link>
            </Button>
          </div>
        </div>
        ...
        <div className="max-w-[1400px] mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-px bg-[#F20000]" />
                <span className="text-[11px] font-medium tracking-widest uppercase text-[#F20000]">Get In Touch</span>
              </div>
              ...
              <p className="text-lg text-[#A0A0A0] leading-relaxed mb-10 max-w-md">
                Questions? Want a demo? Reach out — we respond within 2 hours during business days.
              </p>

              <div className="space-y-4">
                {[
                  { icon: MessageCircle, label: "WhatsApp", value: "+91 98765 43210" },
                  { icon: Heart, label: "Email", value: "hello@fitosys.com" },
                  { icon: CalendarDays, label: "Book a Demo", value: "Schedule a 15-min call" },
                ].map((item, i) => (
                  <a key={i} href="#" className="group flex items-center gap-4 p-5 bg-[#111111] border border-[#222222] hover:border-[#F20000] transition-colors">
                    ...
                    <div>
                      <div className="text-[11px] font-medium uppercase tracking-wider text-[#A0A0A0]">{item.label}</div>
                      <div className="text-sm font-medium text-white group-hover:text-[#F20000] transition-colors">{item.value}</div>
                    </div>
                  </a>
                ))}
              </div>
            ...
            <div className="bg-[#111111] border border-[#222222] p-10">
              <h3 className="text-xl font-medium text-white mb-2">Request a Demo</h3>
              <p className="text-sm text-[#A0A0A0] mb-8">Tell us about your coaching business.</p>
              <form className="space-y-5">
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[11px] font-medium uppercase tracking-wider text-[#A0A0A0] mb-2">Name</label>
                    <input type="text" className="w-full bg-[#0A0A0A] border border-[#222222] text-white px-4 py-3 text-sm focus:outline-none focus:border-[#F20000] transition-colors" placeholder="Your name" />
                  </div>
                  <div>
                    <label className="block text-[11px] font-medium uppercase tracking-wider text-[#A0A0A0] mb-2">Email</label>
                    <input type="email" className="w-full bg-[#0A0A0A] border border-[#222222] text-white px-4 py-3 text-sm focus:outline-none focus:border-[#F20000] transition-colors" placeholder="you@example.com" />
                  </div>
                </div>
                <div>
                  <label className="block text-[11px] font-medium uppercase tracking-wider text-[#A0A0A0] mb-2">Coaching Type</label>
                  <select className="w-full bg-[#0A0A0A] border border-[#222222] text-white px-4 py-3 text-sm focus:outline-none focus:border-[#F20000] transition-colors appearance-none">
                ...
                <div>
                  <label className="block text-[11px] font-medium uppercase tracking-wider text-[#A0A0A0] mb-2">Current Client Count</label>
                  <select className="w-full bg-[#0A0A0A] border border-[#222222] text-white px-4 py-3 text-sm focus:outline-none focus:border-[#F20000] transition-colors appearance-none">
                    <option>0-10 clients</option>
                    <option>11-25 clients</option>
                    <option>26-50 clients</option>
                    <option>50+ clients</option>
                  </select>
                </div>
                <Button type="submit" className="w-full bg-[#F20000] hover:bg-[#C20000] text-white h-12 text-sm font-medium uppercase tracking-wider">
                  Request Demo
                </Button>
              </form>
            </div>
      ...
      <footer className="bg-[#111111] border-t border-[#222222] py-16">
        <div className="max-w-[1400px] mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 pb-12 border-b border-[#222222] mb-8">
            <div>
              <div className="font-display font-medium text-2xl tracking-tight text-white mb-4">FITO<span className="text-[#F20000]">SYS</span></div>
            ...
            <div>
              <div className="text-[11px] font-medium uppercase tracking-widest text-white mb-5">Product</div>
            ...
            <div>
              <div className="text-[11px] font-medium uppercase tracking-widest text-white mb-5">Company</div>
              <div className="space-y-2.5">
            ...
            <div>
              <div className="text-[11px] font-medium uppercase tracking-widest text-white mb-5">Legal</div>
              <div className="space-y-2.5">
